...
- The committed Drizzle migration set creates a clean database and is verified against isolated PostgreSQL; notifications, deployment, and a populated demo relationship seed remain incomplete.
