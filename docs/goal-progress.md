...
- Current state: schema normalization, migration generation, local database verification, reset/seed verification, and the complete local quality gate are complete; Phase 1 PR remains to be published.
...
- Review the complete Phase 1 diff, publish the PR, self-review it, merge with a merge commit, and synchronize main.
...
Run the full Phase 1 gate, then push `feat/11-database-contract`, create the PR, add the self-review comment, and merge only after required checks pass.
