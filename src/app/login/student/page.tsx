      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-12 xl:px-16 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
        <div className="mx-auto w-full max-w-sm">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-600 text-white shadow-lg mb-4">
              <GraduationCap className="h-7 w-7" />
            </div>
            <span className="inline-flex items-center rounded-full bg-purple-100 dark:bg-purple-950/60 px-3 py-1 text-xs font-semibold text-purple-700 dark:text-purple-300 mb-2 border border-purple-200 dark:border-purple-800">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <Button type="submit" className="w-full h-10 bg-purple-600 hover:bg-purple-700 text-white font-medium text-sm shadow-md">
