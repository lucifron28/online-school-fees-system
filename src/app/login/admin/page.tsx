      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-12 xl:px-16 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <span className="inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-950/60 px-3 py-1 text-xs font-semibold text-blue-700 dark:text-blue-300 mb-2 border border-blue-200 dark:border-blue-800">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <Button type="submit" className="w-full h-10 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm shadow-md">
